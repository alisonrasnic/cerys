...
func update(host, delta):
	...
	if host.stats_component and not host.stats_component.is_exhaust():
		if Global.GameState["PlayerIsAggroed"]:
			print("Reducing stamina in aggro...");
			host.stats_component.add_stam(-host.stats_component.RunStamAmt);
